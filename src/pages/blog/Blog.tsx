...
const POSTS: Post[] = [
  ...
  },
  {
    ...
    category: 'Security',
    tag: 'Account Safety',
    title: 'Why 2FA Is Non-Negotiable for Your Trading Account',
    excerpt: 'Two-factor authentication blocks 99.9% of automated account takeover attempts. Here\'s how to set it up on Oakmont Ridge and best practices for keeping your TOTP codes safe.',
    author: 'James Harrington',
    authorInitials: 'JH',
    date: 'May 5, 2026',
    readTime: '4 min read',
